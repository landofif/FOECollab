        ...
        try {
            ...
            if((columns & 1) == 0) {
                ...
                textList.forEach(text -> {
                    ...
                    context.drawText(textRenderer, text, scaledX - textRenderer.getWidth(text) / 2 + columnCount.get() * maxLength + maxLength / 2, scaledY - heightTextList / 2 + (countLine.getAndIncrement() * lineHeight), 0xFFFFFFFF, true);
                });
            } else {
                // odd
                textList.forEach(text -> {
                    ...
                    context.drawText(textRenderer, text, scaledX - textRenderer.getWidth(text) / 2 + columnCount.get() * maxLength, scaledY - heightTextList / 2 + (countLine.getAndIncrement() * lineHeight), 0xFFFFFFFF, true);
                });
            }
